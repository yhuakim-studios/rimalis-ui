      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 items-stretch">
        ...
        <div className="lg:col-span-3 bg-black text-white rounded-[24px] p-4 flex flex-col justify-between shadow-card">
          ...
          <div className="pt-3 mt-2 border-t border-white/10 flex flex-col gap-1">
            ...
            >
              <div className="flex items-center gap-2.5">
                {/* Was `text-amber-400`. With a black accent that amber was the
                    only chromatic pixel on the home page, which made a secondary
                    nav item the loudest thing on screen — rule 1 in theme.css.
                    White carries the same emphasis on this black sidebar. */}
                <Tag className="size-4 text-white" strokeWidth={1.75} />
