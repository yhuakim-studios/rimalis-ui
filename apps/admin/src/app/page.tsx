 ...
 *
 * Tables over the /admin/* endpoints. Smallest of the three; built last.
 */
export default function Page() {
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center gap-6 px-6">
      <div>
        <p className="text-sm font-medium text-brand-600">Admin console</p>
        <h1 className="mt-1 text-4xl font-bold tracking-tight">Admin console</h1>
      </div>
      ...
      <dl className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-1 text-sm">
        ...
        <dd className="font-mono">3002</dd>
        <dt className="text-zinc-500">Deploys to</dt>
        <dd className="font-mono">admin.example.com</dd>
      </dl>
    </main>
  );
}
