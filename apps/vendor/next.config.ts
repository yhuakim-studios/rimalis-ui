...
const nextConfig: NextConfig = {
  ...
  // Node Middleware is unsupported by the OpenNext Cloudflare adapter — and the
  // session refresh this app needs must not live in middleware anyway, because
  // the edge runtime inlines env vars at build time and `SESSION_SECRET` is not
  // present then. See the header of src/lib/session.ts.
  images: {
