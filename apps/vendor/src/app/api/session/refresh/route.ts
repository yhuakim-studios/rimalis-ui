 ...
 * back. One extra hop per fifteen minutes for a signed-in vendor.
 *
 ...
 * harmless duplicate — it signs the vendor out everywhere.
 *
 ...
 *    is cleared and the vendor is sent to sign in with an explanation, because
...
/** Never cached. A cached refresh would hand one vendor’s tokens to another. */
